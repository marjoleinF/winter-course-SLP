...
$$ RSS = \sum_{i=1}^n \left( y_i - \beta_0 - \sum^p_{j=1} \beta_j x_{ij} \right)^2 $$

- Best subset and stepwise selection (forward, backward or both) also minimize a fit-plus-penalty criterion:

$$ \sum_{i=1}^n \left( y_i - \beta_0 - \sum^p_{j=1} \beta_j x_{ij} \right)^2 + \lambda \sum^p_{j=1} I (\beta_j \neq 0) $$
...
$$ \sum_{i=1}^n \left( y_i - \beta_0 - \sum^p_{j=1} \beta_j x_{ij} \right)^2 + \lambda \sum^p_{j=1} \beta_j^2$$
...
$$ \sum_{i=1}^n \left( y_i - \beta_0 - \sum^p_{j=1} \beta_j x_{ij} \right)^2 + \lambda \sum^p_{j=1} |\beta_j| $$
